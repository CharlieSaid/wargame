...
INSERT INTO units (squad_id, name, race, class, level, armor, weapon, description) VALUES
    ...
    (5, 'Friedman', 'Man', 'Knight', 1, 'Chainmail', 'Longsword', 'A falcon knight.'),
    (5, 'Ned', 'Man', 'Knight', 1, 'Chainmail', 'Longsword', 'A falcon knight.'),
    (5, 'Edvard', 'Man', 'Knight', 1, 'Chainmail', 'Battleaxe', 'A falcon knight.'),
    (5, 'Jamieson', 'Man', 'Knight', 1, 'Plate Armor', 'Longbow', 'A falcon knight.'),
    (6, 'Moonstone', 'Elf', 'Battlemage', 1, 'Elf Weave', 'Elf Bow', 'An elf soldier.'),
    (6, 'Moonbeam', 'Elf', 'Battlemage', 1, 'Elf Weave', 'Elf Blade', 'An elf soldier.'),
    (6, 'Mooncrest', 'Elf', 'Battlemage', 1, 'Elf Weave', 'Elf Blade', 'An elf soldier.'),
    (6, 'Moonlight', 'Elf', 'Battlemage', 1, 'Elf Weave', 'Greatsword', 'An elf captain.');
